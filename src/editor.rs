use bevy::prelude::*;
use bevy_editor_pls::{prelude::*, controls, editor::{EditorEvent, EditorInternalState}, default_windows, egui_dock, editor_window::EditorWindow};
...
impl EditorWindow for PhysicsSettingsWindow {
    ...
    fn ui(world: &mut World, mut cx: bevy_editor_pls::editor_window::EditorWindowContext, ui: &mut bevy_inspector_egui::egui::Ui) {
