...
use creature_builder::{
    ...
    joint::CreatureJointBuilder,
    limb::CreatureLimbBundle,
...
#[allow(dead_code)]
fn builder_scene(mut commands: Commands, mut meshes: ResMut<Assets<Mesh>>, mut materials: ResMut<Assets<StandardMaterial>>) {
...
#[allow(dead_code)]
fn joint_scene(mut commands: Commands, mut meshes: ResMut<Assets<Mesh>>, mut materials: ResMut<Assets<StandardMaterial>>) {
    let red_id = commands
        .spawn((
